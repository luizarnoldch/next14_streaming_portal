...
const Slider = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SliderPrimitive.Root> & { showThumb?: boolean }
>(({ className, showThumb = true, ...props }, ref) => (
  ...
  >
    ...
    {showThumb && (
      <SliderPrimitive.Thumb className="block h-5 w-5 rounded-full border-2 border-zinc-900 bg-white ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:border-zinc-50 dark:bg-zinc-950 dark:focus-visible:ring-zinc-300" />
    )}
  </SliderPrimitive.Root>
))
